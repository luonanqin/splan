 ...
 * <p>
 * 收益19626 avgRatio1.0075334770435773
 * <p>
 */
public class Strategy12_6 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String stock : stockSet) {
            ...
            if (StringUtils.isBlank(bollFilePath)) {
                continue;
            }
...
//                    continue;
        ...
        // 2023年的交易日期
        List<StockKLine> dateKLines = BaseUtils.loadDataToKline(Constants.HIS_BASE_PATH + "merge/AAPL", 2024, 2023);
...
//                                insertFilter(filter7List, afterFilter);
                ...
                if (successRatio> 0.6 && (successRatio > maxSuccessRatio || successRatio == maxSuccessRatio && successAvgGain > maxAvgGain)) {
