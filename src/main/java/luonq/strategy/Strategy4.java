 ...
 *
 * 结果：截止六月底
 * openRange=6, hit=0.9, loss=0.09, sum=41596, gainCount=98, lossCount=61, successRatio=0.6163522012578616
 */
...
//                            System.out.println();
                        ...
                        for (Map.Entry<String, Double> stockEntry : stocksEntry) {
                            ...
                            if (kLine == null || boll == null || lastBoll == null || openBoll == null || prevStockKLineMap == null) {
                                continue;
                            }
