...
/**
 * 在OverBollinerDn的基础上，只选择偏离DN最多的交易
 */
public class Strategy19 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int beforeYear = 2023, afterYear = 2021, afterYear2 = 2023;
        double capital = init;
                ...
                for (int i = 0; i < hitRatio.size(); i++) {
                    ...
                    for (int j = 1; j < dateList.size(); j++) {
                        ...
                        for (String stock : stocks) {
                            ...
                            double highOpenRatio = high / open - 1;
                            ...
                            sum -= count * open;
                            if (highOpenRatio > highRatio) {
                                double gain = count * open * highRatio;
                                income += gain;
                                System.out.println("date=" + date + ", stock=" + stock + ", open=" + open + ", close=" + close + ", volumn=" + volume + ", count=" + count + ", gainHigh = " + (int) gain * exchange);
