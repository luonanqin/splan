...
public class BasicQuote implements FTSPI_Qot, FTSPI_Conn {
    ...
    public void addChinaUserSecurity(String code, String groupName) {
        if (StringUtils.startsWith(code, "0")) {
            addUserSecurity(Lists.newArrayList(code), groupName, QotCommon.QotMarket.QotMarket_CNSZ_Security_VALUE);
        } else {
            addUserSecurity(Lists.newArrayList(code), groupName, QotCommon.QotMarket.QotMarket_CNSH_Security_VALUE);
        }
    }
