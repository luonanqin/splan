...
/**
 * 测试场景：涨停后出现长上影然后三天内最高点冲过上影线的最高点，但是量没有萎缩，至少大于涨停那天的90%，然后丛涨停那天计算需要花多长时间才能有30%的盈利
 * 测试结果：
 * 结论：
 * 例子：603757 2025-07-31 ~ 2025-08-06
 */
public class Test9 extends BaseFilter {

    public static void main(String[] args) {
        LoadData.init();
        Test9 test3 = new Test9();
        //        cal();
        //                test(10);
