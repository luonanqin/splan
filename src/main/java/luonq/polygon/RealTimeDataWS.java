...
public class RealTimeDataWS {
    ...
    public static Map<String, OverBollingerLastDay2023.StockRatio> originRatioMap;
    ...
    public void init() {
        try {
            ...
            originRatioMap = OverBollingerLastDay2023.computeHistoricalOverBollingerRatio(2023);
    ...
    private Set<String> buildStockSet(Map<String, String> fileMap) throws Exception {
        ...
        for (String stock : originRatioMap.keySet()) {
            ...
            for (OverBollingerLastDay2023.RatioBean ratio : ratioMap.values()) {
