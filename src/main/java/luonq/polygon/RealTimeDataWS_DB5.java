...
@ClientEndpoint
@Slf4j
public class RealTimeDataWS_DB5 {
    ...
    private OptionTradeExecutor5 optionTradeExecutor5;
    private OptionStockListener5 optionStockListener5;
    ...
    public void initVariable() {
        ...
        unsubscribe = false;
        optionStockListener5 = new OptionStockListener5();
    ...
    public void initTrade() {
        try {
            tradeApi = new TradeApi(true); // todo true为模拟交易
            ...
            optionTradeExecutor5 = new OptionTradeExecutor5();
            optionTradeExecutor5.setFutuQuote(futuQuote);
            optionTradeExecutor5.setTradeApi(tradeApi);
            optionTradeExecutor5.setClient(this);
            optionTradeExecutor5.setOptionStockListener(optionStockListener5);
            optionStockListener5.setOptionTradeExecutor(optionTradeExecutor5);
    ...
    public void initMessageListener() {
        try {
            tradeEventBus.register(optionStockListener5);
        ...
        try {
            while (true) {
                ...
                if (!unsubscribe && currentTime > listenEndTime + 1000) {
                    ...
                    Set<String> canTradeStocks = optionStockListener5.getCanTradeStocks();
    ...
    public void beginTrade() throws Exception {
        ...
        optionTradeExecutor5.beginTrade();
    }
    ...
    public void beginTrade(String msg) throws Exception {
        ...
        unsubscribeAll();
        listenEnd = true;
        getRealtimeQuoteForOption(optionStockListener5.getCanTradeStocks());
        ReadWriteOptionTradeInfo.writeStockOpenPrice();
        //        asynCheckExecutor3();
        optionTradeExecutor5.beginTrade();
