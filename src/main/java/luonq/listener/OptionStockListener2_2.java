...
@Slf4j
@Data
public class OptionStockListener2_2 {
    ...
    public Map<String/* stock */, Double/* open */> openPriceMap = Maps.newHashMap();

    private OptionTradeExecutor2_2 optionTradeExecutor;

    public void setOptionTradeExecutor(OptionTradeExecutor2_2 optionTradeExecutor) {
