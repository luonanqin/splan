...
public final class Constants {
    ...
    public static final String USER_PATH = "/Users/Luonanqin/study/intellij_idea_workspaces/splan/";
    ...
    public static final String HIS_BASE_PATH = USER_PATH + "src/main/resources/historicalData/";
    public static final String GRAB_PATH = HIS_BASE_PATH + "grab/";
    public static final String GRAB_ONE_YEAR_PATH = USER_PATH + "src/main/resources/historicalData/graboneyear/";
    public static final String DAILY_PATH = HIS_BASE_PATH + "daily/";
    public static final String WEEKLY_PATH = HIS_BASE_PATH + "weekly/";
    public static final String FIX_WEEKLY_PATH = USER_PATH + "src/main/resources/historicalData/fixWeekly/";

    public static final String STD_BASE_PATH = USER_PATH + "src/main/resources/standardData/";
    ...
    public static final String INDICATOR_BASE_PATH = USER_PATH + "src/main/resources/indicatorData/";
    ...
    public static final String TRADE_PATH = USER_PATH + "src/main/resources/tradeData/";
