...
public class OptionTradeTest2_2 extends BaseTest {
...
//        optionTradeExecutor.getRealTimeIV();
    ...
    public void test_begintrade() throws Exception {
        ...
        RealTimeDataWS_DB2_2.realtimeQuoteForOptionMap.put(stock, open);
    ...
    @Test
    public void test_getGreek(){
        OptionTradeExecutor2_2 optionTradeExecutor2_2 = new OptionTradeExecutor2_2();
        optionTradeExecutor2_2.setHasFinishBuying(false);
        Map<String, List<String>> map = Maps.newHashMap();
        map.put("NVDA", Lists.newArrayList("O:NVDA241129C00142000", "O:NVDA241129P00142000", "O:NVDA241129C00143000", "O:NVDA241129P00143000", "O:NVDA241129C00144000", "O:NVDA241129P00144000", "O:NVDA241129C00145000", "O:NVDA241129P00145000", "O:NVDA241129C00146000", "O:NVDA241129P00146000", "O:NVDA241129C00147000", "O:NVDA241129P00147000", "O:NVDA241129C00148000", "O:NVDA241129P00148000", "O:NVDA241129C00149000", "O:NVDA241129P00149000", "O:NVDA241129C00150000", "O:NVDA241129P00150000"));
        optionTradeExecutor2_2.setUpDownOptionMap(map);
        optionTradeExecutor2_2.getPolygonRealTimeGreeks();
    }
